import{o as m,d as O,i as x,b as u,n as B,f as j,g as D,m as C,j as I,k as b,l as k,v as F,q as V,r as _,s as N,t as L,e as R,u as E,c as q,F as A}from"./index-12d4141e.js";import{P as M}from"./project-a76972a6.js";var P={name:"Toggle",emits:["input","update:modelValue","change"],props:{value:{validator:function(e){return l=>["number","string","boolean"].indexOf(typeof l)!==-1||l==null},required:!1},modelValue:{validator:function(e){return l=>["number","string","boolean"].indexOf(typeof l)!==-1||l==null},required:!1},id:{type:[String,Number],required:!1,default:"toggle"},name:{type:[String,Number],required:!1,default:"toggle"},disabled:{type:Boolean,required:!1,default:!1},required:{type:Boolean,required:!1,default:!1},falseValue:{type:[String,Number,Boolean],required:!1,default:!1},trueValue:{type:[String,Number,Boolean],required:!1,default:!0},onLabel:{type:[String,Object],required:!1,default:""},offLabel:{type:[String,Object],required:!1,default:""},classes:{type:Object,required:!1,default:()=>({})},labelledby:{type:String,required:!1},describedby:{type:String,required:!1},aria:{required:!1,type:Object,default:()=>({})}},setup(e,l){const t=function(o,c,r){const{value:d,modelValue:i,falseValue:n,trueValue:a,disabled:y}=b(o),s=i&&i.value!==void 0?i:d,h=k(()=>s.value===a.value),v=g=>{c.emit("input",g),c.emit("update:modelValue",g),c.emit("change",g)},S=()=>{v(a.value)},T=()=>{v(n.value)};return[null,void 0,!1,0,"0","off"].indexOf(s.value)!==-1&&[n.value,a.value].indexOf(s.value)===-1&&T(),[!0,1,"1","on"].indexOf(s.value)!==-1&&[n.value,a.value].indexOf(s.value)===-1&&S(),{externalValue:s,checked:h,update:v,check:S,uncheck:T,handleInput:g=>{v(g.target.checked?a.value:n.value)},handleClick:()=>{y.value||(h.value?T():S())}}}(e,l),w=function(o,c,r){const{trueValue:d,falseValue:i,onLabel:n,offLabel:a}=b(o),y=r.checked,s=r.update;return{label:k(()=>{let h=y.value?n.value:a.value;return h||(h="&nbsp;"),h}),toggle:()=>{s(y.value?i.value:d.value)},on:()=>{s(d.value)},off:()=>{s(i.value)}}}(e,0,{checked:t.checked,update:t.update}),p=function(o,c,r){const d=b(o),i=d.disabled,n=r.checked,a=k(()=>({container:"toggle-container",toggle:"toggle",toggleOn:"toggle-on",toggleOff:"toggle-off",toggleOnDisabled:"toggle-on-disabled",toggleOffDisabled:"toggle-off-disabled",handle:"toggle-handle",handleOn:"toggle-handle-on",handleOff:"toggle-handle-off",handleOnDisabled:"toggle-handle-on-disabled",handleOffDisabled:"toggle-handle-off-disabled",label:"toggle-label",...d.classes.value}));return{classList:k(()=>({container:a.value.container,toggle:[a.value.toggle,i.value?n.value?a.value.toggleOnDisabled:a.value.toggleOffDisabled:n.value?a.value.toggleOn:a.value.toggleOff],handle:[a.value.handle,i.value?n.value?a.value.handleOnDisabled:a.value.handleOffDisabled:n.value?a.value.handleOn:a.value.handleOff],label:a.value.label}))}}(e,0,{checked:t.checked}),f=function(o,c,r){const{disabled:d}=b(o),i=r.check,n=r.uncheck,a=r.checked;return{handleSpace:()=>{d.value||(a.value?n():i())}}}(e,0,{check:t.check,uncheck:t.uncheck,checked:t.checked});return{...t,...p,...w,...f}}};const G=["tabindex","aria-checked","aria-describedby","aria-labelledby"],U=["id","name","value","checked","disabled"],z=["innerHTML"],W=["checked"];P.render=function(e,l,t,w,p,f){return m(),O("div",C({class:e.classList.container,tabindex:t.disabled?void 0:0,"aria-checked":e.checked,"aria-describedby":t.describedby,"aria-labelledby":t.labelledby,role:"switch"},t.aria,{onKeypress:l[1]||(l[1]=I(V((...o)=>e.handleSpace&&e.handleSpace(...o),["prevent"]),["space"]))}),[x(u("input",{type:"checkbox",id:t.id,name:t.name,value:t.trueValue,checked:e.checked,disabled:t.disabled},null,8,U),[[F,!1]]),u("div",{class:B(e.classList.toggle),onClick:l[0]||(l[0]=(...o)=>e.handleClick&&e.handleClick(...o))},[u("span",{class:B(e.classList.handle)},null,2),j(e.$slots,"label",{checked:e.checked,classList:e.classList},()=>[u("span",{class:B(e.classList.label),innerHTML:e.label},null,10,z)]),t.required?(m(),O("input",{key:0,type:"checkbox",style:{appearance:"none",height:"1px",margin:"0",padding:"0",fontSize:"0",background:"transparent",position:"absolute",width:"100%",bottom:"0",outline:"none"},checked:e.checked,"aria-hidden":"true",tabindex:"-1",required:""},null,8,W)):D("v-if",!0)],2)],16,G)},P.__file="src/Toggle.vue";const H={style:{position:"absolute",left:"2%"}},J=u("br",null,null,-1),K=u("br",null,null,-1),$={__name:"Bard-Is-Broke",setup(e){const l=_(!1),t=_("");return N(()=>{t.value=l.value?"Gameplay":"Tools"}),(w,p)=>(m(),O(A,null,[u("div",H,[u("h4",null,L(t.value),1),R(E(P),{modelValue:l.value,"onUpdate:modelValue":p[0]||(p[0]=f=>l.value=f)},null,8,["modelValue"])]),J,K,l.value?(m(),q(M,{key:0,"project-pictures":["/BiBGameplayMedia/BiB_anim.gif","/BiBGameplayMedia/vn_ava.png","/BiBGameplayMedia/vn_mic.png","/BiBGameplayMedia/BiB_Trailer.mp4"],"project-links":{"itch.io":"https://vfs-gdpg.itch.io/bard-is-broke"},"code-snippets":{"SequenceManager Snippet ▼":`// this guy just allows other classes 
